...
class fs_controller
{
   ...
   public function __construct($name = '', $title = 'home', $folder = '', $admin = FALSE, $shmenu = TRUE, $important = FALSE)
   {
      ...
      {
         $this->new_error_msg('ECON necesita PHP 5.3 o superior, y tú tienes PHP '.phpversion().'.');
      }
   ...
   /**
    * Devuelve la versión de ECON
    * @return type versión de ECON
    */
