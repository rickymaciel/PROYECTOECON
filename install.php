...
function guarda_config($nombre_archivo)
{
   ...
   if($archivo)
   {
      ...
      fwrite($archivo, " * ECON conectadas al mismo servidor memcache.\n");
      fwrite($archivo, " */\n");
      fwrite($archivo, "\n");
...
$system_info = 'ECON: '.file_get_contents('VERSION')."\n";
...
<head>
   ...
   <title>ECON</title>
   <meta name="description" content="ECON." />
   <meta name="viewport" content="width=device-width, initial-scale=1.0" />
   <link rel="shortcut icon" href="view/img/favicon.ico" />
   <link rel="stylesheet" href="view/css/bootstrap-cosmo.min.css" />
   ...
   <nav class="navbar navbar-default" role="navigation" style="margin: 0px;">
      <div class="container-fluid">
         <div class="navbar-header">
            ...
            <a class="navbar-brand" href="index.php">ECON</a>
         </div>
      </div>
   </nav>
   ...
   <div class="container">
      <div class="row">
         <div class="col-sm-12">
            <div class="page-header">
               <h1>
                  Bienvenido al instalador de ECON
         ...
         <div class="col-sm-12">
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     La carpeta de ECON no tiene permisos de escritura. Sin esos
                     permisos, no funcionará ECON.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     ECON necesita PHP 5.3 o superior, y tú estás usando <?php echo phpversion() ?>.
                  </p>
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     ECON necesita la extensión mbstring para poder trabajar con caracteres
            ...
            <div class="panel panel-danger">
               ...
               <div class="panel-body">
                  <p>
                     ECON necesita la extensión OpenSSL para poder descargar plugins,
      ...
      <div class="row" style="margin-bottom: 20px;">
         <div class="col-sm-12 text-center">
            <hr/>
            <small>
               © 2016 <a target="_blank" href="">ECON</a>
            </small>
         </div>
      </div>
   </div>
